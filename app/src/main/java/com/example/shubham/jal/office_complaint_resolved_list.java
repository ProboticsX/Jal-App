...
public class office_complaint_resolved_list extends ArrayAdapter<String> {
    ...
    public office_complaint_resolved_list(Activity context, ArrayList<String> complaintno_stack, ArrayList<String>date_stack, ArrayList<String>category_stack, ArrayList<String>problem_stack,
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        final View rowView=inflater.inflate(R.layout.office_complaint_resolved_listitem, null,true);
        mDatabase = FirebaseDatabase.getInstance().getReference();

        final TextView tv_complaintno_stack=rowView.findViewById((R.id.tv_complaintno_resolved_office));
        TextView tv_date_stack=rowView.findViewById((R.id.tv_date_resolved_office));
        TextView tv_category_stack=rowView.findViewById((R.id.tv_category_resolved_office));
        TextView tv_problem_stack=rowView.findViewById((R.id.tv_problem_resolved_office));
        TextView tv_dateresolved=rowView.findViewById((R.id.tv_dateresolved_resolved_office));
        ...
        ImageButton ib_download_stack=rowView.findViewById(R.id.ib_download_resolved_office);
